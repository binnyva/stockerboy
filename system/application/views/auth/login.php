...
<div id="login-container">
  ...
  <div id="login-box">
    ...
    <form action="<?php echo site_url('auth/login'); ?>" method="post" >
   	  <label><input name="email" id="email" type="text" class="textfield" value="Username" onfocus="if(this.value=='Username'){this.value=''};" onblur="if(this.value==''){this.value='Username'};" /></label>
    	<label>
  ...
  <div id="bottom"></div>
  <div id="Forgot">Forgot your password? <a href="#">Click here to reset it.</a></div>
</div>
</body>
</html>